<div class="flex-1 flex flex-col overflow-hidden bg-white dark:bg-[#0a0a0a]">
    ...
    <nav class="border-b border-gray-200 dark:border-white/5 bg-white dark:bg-[#0d0d0d]">
        ...
        <div class="flex items-center gap-3 px-4 pb-3 flex-wrap">
            ...
            {{-- Exportar Excel --}}
            <a href="{{ route('proyectos.gantt.export.excel', $proyecto) }}"
               class="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border text-xs font-black uppercase tracking-wider transition-all shrink-0
                      border-gray-200 dark:border-white/10 text-gray-500 dark:text-gray-600 hover:border-green-500/50 hover:text-green-600 dark:hover:text-green-400"
            ...
            {{-- Exportar PDF --}}
            <a href="{{ route('proyectos.gantt.export.pdf', $proyecto) }}"
               class="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border text-xs font-black uppercase tracking-wider transition-all shrink-0
                      border-gray-200 dark:border-white/10 text-gray-500 dark:text-gray-600 hover:border-red-500/50 hover:text-red-600 dark:hover:text-red-400"
               title="Exportar PDF">
                <svg class="w-3 h-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
